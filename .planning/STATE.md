...
Progress: v1.0-v2.0 (32p, 82pl) complete | v2.1: defining
...
- [v2.1]: BuiltinValue signature (Value -> Value) cannot carry tailPos — structural limitation
...
- TCO regression: `let rec loop n = if n = 0 then 0 else loop (n - 1)` with 1M iterations → Stack overflow
...
*Last updated: 2026-03-25 (v2.1 milestone started)*
