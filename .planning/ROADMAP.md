...
- [x] **Phase 2: Algebraic Data Types** - Sum types with pattern matching and type parameters
...
- [ ] 02-02-PLAN.md — Type system extension with TData constructor and ConstructorEnv
...
Plans:
- [ ] 03-01-PLAN.md — AST nodes, type definitions, elaboration, diagnostics, lexer tokens, and parser token declarations
...
- [ ] 03-04-PLAN.md — Evaluator support for record creation (with type name resolution), field access, copy-and-update, and equality
- [ ] 03-05-PLAN.md — Integration tests for all record features (REC-01 through REC-06) with bug fixes
- [ ] 03-06-PLAN.md — Mutable field syntax: MUTABLE/LARROW tokens, SetField AST, parser rules, formatting
- [ ] 03-07-PLAN.md — Mutable field semantics: type checking, ref-cell evaluation, and tests (REC-07)
