...
Requirements for v1.3 Language Completion milestone.
...
| Feature | Reason |
|---------|--------|
| Module-level let rec (단일 함수) | 이미 expression-level let rec 지원; module-level은 MUTREC과 함께 구현 |
| Tail call optimization for mutual recursion | 단일 함수 TCO만 v1.3 범위; mutual TCO는 v1.4 |
| Active patterns | F# 고급 기능, v1.4+ |
| Computation expressions | 모나드 문법, v1.4+ |
