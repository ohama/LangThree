...
- Tail call optimization (TCO) — v1.3
- Or-patterns (`| 1 | 2 -> ...`) — v1.3
- String patterns in match — v1.3
- Type aliases (`type Name = string`) — v1.3
- List ranges (`[1..10]`) — v1.3
- Let rec ... and ... (mutual recursive functions) — v1.3

### Future (v1.4+)

- User-defined operators — v1.4
...
**Shipped:** v1.2 Practical Language Features (2026-03-18)
- 23 source files, 9,112 lines of F#
- 456 tests (196 F# + 260 fslit), all passing
- 12 phases, 44 plans executed across v1.0-v1.2
...
## Current Milestone: v1.3 Language Completion

**Goal:** TCO, or-패턴, 타입 별칭, 리스트 범위, 상호 재귀로 언어 완성도 향상

**Target features:**
- Tail call optimization (trampoline 방식)
- Or-patterns and string patterns in match
- Type aliases (`type Name = string`)
- List ranges (`[1..5]`)
- Mutual recursive functions (`let rec f = ... and g = ...`)
