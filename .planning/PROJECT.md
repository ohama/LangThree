...
- Unit type `()` — v1.2
- String operations (length, concat, substring, etc.) — v1.2
- `printf` formatted output — v1.2
...
**Goal:** 파이프 연산자, unit 타입, 문자열 연산, printf로 실용적 프로그래밍 가능하게

**Target features:**
- `|>` 파이프 연산자, `>>` 합성 연산자
- Unit 타입 `()` (부수효과 표현)
- 문자열 내장 함수 (string_length, string_concat, string_sub 등)
- printf 포맷 출력
