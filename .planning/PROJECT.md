...
**Goal:** FunLexYacc 프로젝트에서 발견된 24개 제약사항 전면 해결. LangThree를 실용적 프로젝트에서 해킹 없이 사용 가능한 언어로.
...
- File I/O (`read_file`, stdin reading)
