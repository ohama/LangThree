...
- AST Span 위치 정보 수정 — PositionedToken + IndentFilter 위치 보존 + lexbuf 업데이트
- 에러 메시지에 실제 file:line:column 표시 (현재 :0:0:)
...
## Current Milestone: v9.1 Span Fix

**Goal:** AST Span 위치 정보 정확성 — 에러 메시지에 실제 소스 위치(line:column) 표시

**Target features:**
- PositionedToken 타입 (토큰 + 위치 정보)
- IndentFilter 위치 보존 필터링
- parseModuleFromString lexbuf 위치 업데이트
- 에러 메시지에 정확한 file:line:column 출력
...
---
*Last updated: 2026-03-31 after v9.0 milestone completed*
