...
- Comprehensive tutorial documentation (13 chapters) — v1.3

### Future (v1.4)

- Tail call optimization (TCO) — v1.4
- Or-patterns (`| 1 | 2 -> ...`) — v1.4
- String patterns in match — v1.4
- Type aliases (`type Name = string`) — v1.4
- List ranges (`[1..10]`) — v1.4
- Let rec ... and ... (mutual recursive functions) — v1.4
...
**Goal:** 함수형 프로그래밍 경험자를 위한 포괄적 LangThree 튜토리얼 작성

**Target:**
- tutorial/ 디렉토리에 13개 마크다운 챕터
- 모든 언어 기능을 실행 가능한 예제와 함께 설명
- F#/OCaml 경험자가 바로 사용할 수 있는 수준

---
*Last updated: 2026-03-18 after v1.3 Tutorial milestone started*
