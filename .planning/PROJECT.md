...
- 214 tests (F# unit + fslit + integration), all passing
...
- File-based module imports, char type, N-tuples, 14 I/O builtins
...
---
*Last updated: 2026-03-25 after v2.0 milestone complete (34/34 requirements shipped)*
